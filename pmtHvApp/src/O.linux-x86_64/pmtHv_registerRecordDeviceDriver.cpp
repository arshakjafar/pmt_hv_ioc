...
/* Generated from ../O.Common/pmtHv.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devAiGeneralTime, *pvar_dset_devPmtHvAI,
    *pvar_dset_devPmtAI, *pvar_dset_devAoSoft, *pvar_dset_devAoSoftRaw,
    *pvar_dset_devAoSoftCallback, *pvar_dset_devPmtHvAO,
    *pvar_dset_devPmtAO, *pvar_dset_devBiSoft, *pvar_dset_devBiSoftRaw,
...
static const char * const deviceSupportNames[] = {
    ...
    "devPmtHvAI", "devPmtAI", "devAoSoft", "devAoSoftRaw",
    "devAoSoftCallback", "devPmtHvAO", "devPmtAO", "devBiSoft",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devPmtHvAI, pvar_dset_devPmtAI, pvar_dset_devAoSoft,
    pvar_dset_devAoSoftRaw, pvar_dset_devAoSoftCallback,
    pvar_dset_devPmtHvAO, pvar_dset_devPmtAO, pvar_dset_devBiSoft,
...
epicsShareExtern int * const pvar_int_g_hvErrCheckMask;
...
static struct iocshVarDef vardefs[] = {
    ...
    {"g_hvErrCheckMask", iocshArgInt, pvar_int_g_hvErrCheckMask},
...
int pmtHv_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/admin1/Test/pmt-hv-ioc";
...
/* pmtHv_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: pmtHv_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(pmtHv_registerRecordDeviceDriver(*iocshPpdbbase));
}
